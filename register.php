<head>
  ...
  <style>
    ...
    .page-wrapper {
      position: relative;
      overflow: hidden;
      background: url('./assets/images/logos/bg-login.jpg') center/cover no-repeat fixed; /* Add this line for background image */
    }
      ...
      <div class="d-flex align-items-center justify-content-center w-100">
        <div class="row justify-content-center w-100">
          <div class="col-md-8 col-lg-3 col-lg-3">
            <div class="card mb-0">
              <div class="card-body">
                <a href="./login.html" class="text-nowrap logo-img text-center d-block py-3 w-100">
                ...
                <form method="post" action="aksi_register.php">
                  ...
                  <button class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2" type="submit" name="submit">Sign Up</button>
